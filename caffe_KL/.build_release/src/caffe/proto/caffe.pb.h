...
enum V1LayerParameter_LayerType {
  ...
  V1LayerParameter_LayerType_SOFTMAX_KL_LOSS = 43,
  V1LayerParameter_LayerType_SOFTMAX_MY_KL_LOSS = 44,
...
const V1LayerParameter_LayerType V1LayerParameter_LayerType_LayerType_MAX = V1LayerParameter_LayerType_SOFTMAX_MY_KL_LOSS;
...
class V1LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType SOFTMAX_KL_LOSS = V1LayerParameter_LayerType_SOFTMAX_KL_LOSS;
  static const LayerType SOFTMAX_MY_KL_LOSS = V1LayerParameter_LayerType_SOFTMAX_MY_KL_LOSS;
