#ifndef CAFFE_SOFTMAX_WITH_KL_LOSS_LAYER_HPP_
#define CAFFE_SOFTMAX_WITH_KL_LOSS_LAYER_HPP_
...
class SoftmaxWithKLLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit SoftmaxWithKLLossLayer(const LayerParameter& param)
