...
_V1LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_KL_LOSS', index=35, number=43,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_MY_KL_LOSS', index=36, number=44,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
